...
if(isset($_SESSION['login_id'])){
	...
	$qry="insert into users(name,contact,address,email,password)values('$name','$contact','$address','$email','$password')";
	      ...
	      <div class="col-md-12">
	      	<div class="row">
	      		<div class="col-md-6 border-right">
			          ...
			          <input type="text" class="form-control" name="name" required placeholder="Name" pattern="[a-z A-Z]*" required value="<?php echo isset($name) ? $name : '' ?>">
			        ...
			        <div class="input-group mb-3">
			          <input type="text" class="form-control" name="contact" required placeholder="Contact Number" pattern="[0-9]{10}" required value="<?php echo isset($contact) ? $contact : '' ?>">
			          <div class="input-group-append">
			            <div class="input-group-text">
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					$('#signup-form').prepend('<div class="alert alert-danger">Username or password is incorrect.</div>')
					end_load();
				}
			}
		})
