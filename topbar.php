<!-- Navbar -->
  ...
  <marquee 
        ...
        <a href="https://www.bankbazaar.com/gold-rate-maharashtra.html" background-color="white"><b>Todays Gold rate<b></a>
        </marquee>
    <!-- Left navbar links -->
    <div class="container">
      ...
      <?php endif; ?>
        <li>
          <a class="nav-link text-white"  href="./" role="button"> <large><b>Ashirwad Jewellers</b></large></a>
        </li>
      </ul>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link nav-home" href="heading1.html">
            <b>Back</b>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link nav-home" href="https://www.bankbazaar.com/gold-rate-maharashtra.html">
            <b>Rate</b>
          </a>
        </li>
        <?php if(!isset($_SESSION['login_id'])): ?>
